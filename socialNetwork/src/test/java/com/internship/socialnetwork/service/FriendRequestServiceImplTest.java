...
class FriendRequestServiceImplTest {
    ...
    private final String FRIEND_REQUEST_NOT_FOUND_MESSAGE = "Friend request between users 1 and 2 doesn't exist!";
    ...
    void shouldCreateRequest() {
        ...
        when(friendRequestRepository.findById((FriendRequestId) any())).thenReturn(Optional.empty());
        ...
        verify(friendRequestRepository).findById((FriendRequestId) any());
    ...
    void shouldThrowBadRequestException_whenCreateRequest_ifRequestAlreadyExists() {
        ...
        when(friendRequestRepository.findById((FriendRequestId) any())).thenReturn(Optional.of(friendRequest));
